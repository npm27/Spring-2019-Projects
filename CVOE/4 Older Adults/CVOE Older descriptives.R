...
#subID = c("1001", "1002", "1003", "1006", "1007", "1008", "1009", "1010", "1011", "1013", "1014",
...
##put it all together
output_errors = data.frame(output$subID, mean_cv_errors, mean_oe_errors, pure_block_errors,
...
output_RT = data.frame(output2$subID, mean_cv_rt, mean_oe_rt, pure_RT,
...
write.csv(output_RT, file = "Older RTs 11_18.csv", row.names = FALSE)
...
##read in trimmed data
trimmed = read.csv("Older_CVOE_Trimmed 11_18.csv")
summary(trimmed)
...
write.csv(output_zRT, file = "Older zRTs 11_18.csv", row.names = FALSE)
